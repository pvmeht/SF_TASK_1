...
<div class="container text-center">
            ...
            <div class="row">
                <h1 class=" py-3 my-3" ALIGN="Center"><u>TRANSACTION</u></h1>
            <div class="col">
                    ...
                    <table class="table my-3 py-3 table-hover table-sm table-striped table-condensed table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="pay.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class=" text-center py4 btn btn-success">Transaction</button></a></td> 
                            </tr>
                            <?php
                                }
                            ?>
